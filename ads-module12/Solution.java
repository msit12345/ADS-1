...
class MinHeap
{
	public boolean Heap(Comparable a[])
    {
		...
		for(int i=0;i<n;i++)
		{
			...
			else
			{
				...
				case "String":size=0;
								...
								System.out.println(mh.Heap(sheap));
								break;
				case "Float":
								size=0;
								...
								System.out.println(mh.Heap(fheap));
								break;
				case "Double":
								size=0;
								...
								System.out.println(mh.Heap(dheap));
								break;
				case "Integer":
								size=0;
								...
								System.out.println(mh.Heap(iheap));
								break;
